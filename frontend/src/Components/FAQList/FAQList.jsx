  ...
  return (
    <div className="faq-list">
      <div className="container">
        <div className="specialheading1">FAQ</div>
        <div className="specialheading2">Frequently Asked Questions</div>
        <p className="specialheading3">Frequently Asked Questions About the Car Rental Booking Process on Our Website: Answers to Common Concerns and Inquiries.</p>
        <div className="list">
